        ...
        <div class="card-body">
          ...
          <form method="POST" action="atualiza_dados.php">
            ...
            <div class="form-group">
              <label for="formGroupExampleInput">Primeiro Nome: <?php echo $exibe['Pnome'];?></label>
              <div class="input-group">
                <input type="text" name="Pnomeup" class="form-control" placeholder="Editar primeiro nome..."  aria-describedby="basic-addon2">
              </div>
            </div>
            <div class="form-group">
              <label for="formGroupExampleInput2">Segundo Nome: <?php echo $exibe['Snome'];?></label>
              <div class="input-group">
                <input type="text" name="Snomeup" class="shadow-lg form-control" id="formGroupExampleInput2" placeholder="Editar segundo nome...">
              </div>
            </div>
            <div class="form-group">
              <label for="formGroupExampleInput2">Nome da Empresa: <?php echo $exibe['nomEmp'];?></label>
              <div class="input-group">
                <input type="text" name="nomeEmpup" class="shadow-lg form-control" id="formGroupExampleInput2" placeholder="Editar nome da empresa...">
              </div>
            </div>
            <div class="form-group">
              <label for="formGroupExampleInput2">Descrição da Empresa: <?php echo $exibe['descEmp'];?></label>
              <div class="input-group">
                <textarea class="shadow_lg form-control" name="descEmpup" id="formGroupExampleInput2" placeholder="Editar descrição da empresa..."></textarea>
              </div>
              <br/>
          ...
          <form method="POST" action="atualiza_login.php">
            ...
            <?php
              ...
              unset($_SESSION['campos_login_vazios']);
               ?>
            <div class="form-group">
              <label for="formGroupExampleInput2">Email: <?php echo $exibe['email']; }?></label>
              <div class="input-group">
                <input type="email" name="emailup" class="shadow-lg form-control" id="formGroupExampleInput2" placeholder="Editar e-mail...">
              </div>
            </div>
            <div class="form-group">
              <label for="formGroupExampleInput2">Senha</label>
              <input type="password" name="senhaatual" class="shadow-lg form-control" id="formGroupExampleInput2" placeholder="Senha atual...">
              <input type="password" name="senhaup" class="shadow-lg form-control" id="formGroupExampleInput2" placeholder="Nova senha...">
              <br/>
              <button class="btn btn-block btn-success shadow-lg" type="submit">Editar</button> 
            </div>
            <hr style="background-color: #fff;">
