...
<body style="background-color: #5271ff;">
    ...
    <nav class="shadow-lg navbar navbar-dark" style="background-color: #1d1d45;">
        ...
        <a href="editest.php" class="shadow-lg btn btn-danger" role="button" aria-pressed="true">Voltar</a>
    </nav>
  </header>
  <div class="jumbotron" style="background-color: #5271ff;">
    <main>
    <div class="card shadow-lg">
    <form method="POST" action="editest3.php">
    <div class="card-body">       
        ...
        <h5  class="card-title">2.Item</h5>
          ...
          <select  name="item" id="inputCatItem" class="shadow form-control">
           ...
           <h5 class="card-title">3.Editar Estoque</h5>
    <div class="form-group input-group mb-3">
    <input type="text" name="editest" class="shadow form-control" id="inputAddress" placeholder="Novo Estoque">
  </div>
