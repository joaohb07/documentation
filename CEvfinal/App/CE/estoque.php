...
$busca_produtos = mysqli_query($con, "SELECT * FROM produtos WHERE categoria ='".$row1['id']."'");
                  ...
                  <div class="collapse" id="<?php echo $row2['nome'];  ?>">
                    <div>
                    <br>
                      <strong>Estoque atual: <?php echo $row2['estoque'];  ?></strong><br/><p style="font-size: 16px;">(*Para mudar, clique em 'editar')</p>
                      <strong> Informações do Produto:</strong>
                      Estoque mínimo: <?php echo $row2['estoqueMin'];  ?><br/>
                      Descrição: <?php echo $row2['descProd'];  ?><br/>
                      Localização: <?php echo $row2['locprod'];  ?><br/>
                      Código: <?php echo $row2['codprod'];  ?>
                    </div>
                  </div>
